...
CREATE USER arthur_hardman@localhost;
-----------------------------------------------------
...
--  Tabela para saber regiao mundial de cada país:
...
-- Tabela para identificar o nome do país dos endereços das sedes:
...
-- Usado para localizar endereços de sedes da empresa:
...
-- Tabela que é usada para verificar os cargos e os salários mínimos e máximos entre os cargos:
...
-- Tabela que contem todos os dados do empregado necessários:
...
-- Comentário sobre a coluna email: Preencher somente até o @ do email
-- Comentário sobre a coluna id_supervisor: Caso tenha um supervisor entre os empregados para ter conhecimento de quem seria.
---------------------------------------------------

-- Tabela para especificar o departamento do empregado:
...
(
 ...
 -- Comentário sobre a coluna id_gerente: Caso tenha um gerente do departamento, essa informação será informada através do relacionamento com a tabela empregados.
------------------------------------------------------

-- Tabela para visualizar o histórico de cada empregado com os cargos que passou
